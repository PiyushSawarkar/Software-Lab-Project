...
$con = pg_connect("$host $port $dbname $credentials");
 if (!$con) {
   echo "CONNECTION FAILED";
	...
	$query="select * from SOFTWARE_LAB order by marks desc limit 10";
	...
	$rs1 = pg_query($con, $sql);
	$count=pg_num_rows($rs1);
	$arr = pg_fetch_all($rs1);
 }
?>
<!DOCTYPE html>
<html lang="en">
          ...
          <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                <a href="admin.php" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i>Moodle</h3>
                </a>
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>Top 10</a>
                        <div class="dropdown-menu bg-transparent border-0">
                             <ul>
                            	<li><a href="DECS_10.php">DECS</a></li>
                            	<li><a href="ALG_10.php">ALGORITHMS</a></li>
                            	<li><a href="DBMS_10.php">DBMS</a></li>
                            	<li><a href="FML_10.php">FML</a></li>
                            	<li><a href="SL_10.php">SOFTWARE LAB</a></li>
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-secondary border-0 rounded-0 rounded-bottom m-0">
                            ...
                            <a href="to-do.php" class="dropdown-item">Upcomig events</a>
                   ...
                   <!-- <div class="col-sm-12 col-xl-6">-->
                        <div class="bg-secondary rounded h-100 p-4">
                           ...
                           <table class="table table-hover">
                               ...
                               while ($row = pg_fetch_row($rs)) {
				 echo "<tr>";
				 echo "<td>$x</td><td> $row[0]</td><td> $row[1] </td>";
				 echo "</tr>";
				 $x++;
				}
                                ?>
